...
public class PlayMusicFragment extends Fragment implements ControllerView.MediaPlayerControl{
    ...
    public TextView mComplexity;
    public TextView mTempo;
    public TextView mHeavyness;
    public Menu mMenu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mComplexity = (TextView) rootView.findViewById(R.id.complexity_label);
        mTempo = (TextView) rootView.findViewById(R.id.tempo_label);
        mHeavyness = (TextView) rootView.findViewById(R.id.heavyness_label);
        mAlbumArt = (ImageView) rootView.findViewById(R.id.album_cover);
        mComplexity.setVisibility(View.INVISIBLE);
        mTempo.setVisibility(View.INVISIBLE);
        mHeavyness.setVisibility(View.INVISIBLE);
