...
/*   TODO: **** HAVE TO CHECK IF PLAYMUSICFRAGMENT WILL RUN HANDLER WHEN FRAGMENT RESUMES ****      */
    ...
    public Dialog showPreferenceSelectionDialog(){
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPlayMusicFragment.mComplexity.setText(String.format("Complexity: %f", song.complexity()));
                mPlayMusicFragment.mTempo.setText(String.format("Tempo: %f", song.tempo()));
                mPlayMusicFragment.mHeavyness.setText(String.format("Heaviness: %f", song.heaviness()));
    ...
    public boolean isPlaying() {
        if (mPlayMusicFragment.isActive) {
